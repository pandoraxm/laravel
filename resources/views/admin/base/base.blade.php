    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./index2.html" class="logo">
          ...
          <span class="logo-lg"><b>网站后台管理</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="{{asset('admins/dist/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">
                    <p>
                      {{ Session('username')->name }} - Web Developer
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> 数据统计</a></li>
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ URL('admin/stu/show')}}"><i class="fa fa-circle-o"></i>浏览学生信息</a></li>
                <li><a href="{{ URL('admin/stu/create')}}"><i class="fa fa-circle-o"></i>添加学生信息</a></li> 
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../layout/top-nav.html"><i class="fa fa-circle-o"></i> 浏览信息</a></li>
                <li><a href="../layout/boxed.html"><i class="fa fa-circle-o"></i> 添加信息</a></li>
